    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
                <a href="{{ route('admin.dashboard') }}" class="nav-lin"><i class="fas fa-fire"></i><span>Dashboard</span></a>
            ...
            <li class="dropdown {{ setActive([
                ...
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-columns"></i> <span>Manage Categories</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li  class="{{ setActive(['admin.sub-category.*']) }}">
                        <a class="nav-link"
                           href="{{ route('admin.sub-category.index') }}">Sub Category</a>
                    </li>
            ...
            <li class="dropdown {{ setActive([
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setActive(['admin.vendor-profile.*']) }}">
                        <a class="nav-link"
                           href="{{ route('admin.vendor-profile.index') }}">Vendor Profile</a>
                    </li>
